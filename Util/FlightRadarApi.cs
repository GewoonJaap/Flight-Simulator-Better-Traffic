...
namespace Simvars.Util
{
    ...
    {
        private const double LongitudeModifier = 0.3;// Info for JAAP: Changed from 0.3 for a bigger area
        private const double LatitudeModifier =  0.5;// Info for JAAP: Changed from 0.5 for a bigger area
